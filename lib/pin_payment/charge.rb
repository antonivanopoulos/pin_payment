module PinPayment
  class Charge < Base
    attr_accessor :token,  :amount,  :currency,  :description,  :email,  :ip_address,  :capture,  :captured,  :created_at,  :card,  :customer,  :success,  :total_fees
    protected     :token=, :amount=, :currency=, :description=, :email=, :ip_address=, :capture=, :captured=, :created_at=, :card=, :customer=, :success=, :total_fees=
    ...
    def self.attributes
      [:token, :amount, :currency, :description, :email, :ip_address, :created_at, :card, :customer, :success, :total_fees, :capture, :captured]
    end
  end
end
